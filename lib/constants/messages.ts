...
// 카테고리 라벨 (lib/config/categories.ts에서 가져옴)
export { CATEGORY_LABELS } from '@/lib/config/categories'
...
export const PAGE_MESSAGES = {
  COMMUNITY_TITLE: 'Eundms',
  WELCOME_MESSAGE: 'Eundms에',
  WELCOME_HIGHLIGHT: '오신 것을 환영합니다',
  WELCOME_DESCRIPTION: '기술을 함께 배우고, 경험을 나누며, 성장하는 개발자들의 공간입니다. GitHub 계정으로 로그인하여',
  WELCOME_JOIN: '참여해보세요.',
  EXPLORE_COMMUNITY: '둘러보기',
  LEARNING_MATERIALS: '학습 자료',
  COMMUNITY_FEATURES: '특징',
  FEATURES_DESCRIPTION: '개발자들을 위한 Study Log의 주요 특징들입니다.',
  GITHUB_INTEGRATION: 'GitHub 통합',
  GITHUB_INTEGRATION_DESC: 'GitHub 계정으로 간편하게 로그인하고 개발자 프로필을 연동하세요.',
  ACTIVE_COMMUNITY: '활발한 커뮤니티',
  ACTIVE_COMMUNITY_DESC: '전문가들과 함께 지식을 공유하고 네트워킹하세요.',
